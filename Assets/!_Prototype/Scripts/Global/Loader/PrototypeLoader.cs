...
public class PrototypeLoader : MonoBehaviour
{
    ...
    // Singleton instance
    public static PrototypeLoader Instance { get; private set; }
    ...
    private IEnumerator LoadLevel(string sceneName)
    {
        ...
        // yield return StartCoroutine(SingletonManager.Instance.Fader.FadeIn());
        ...
        while (!asyncOperation.isDone)
        {
            ...
            if (asyncOperation.progress >= 0.9f)
            {
                ...
                // Start fader fade out coroutine
                // yield return StartCoroutine(SingletonManager.Instance.Fader.FadeOut());
